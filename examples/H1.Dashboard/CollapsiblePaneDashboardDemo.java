        ...
        manager.addGadgetListener(new GadgetListener() {
            public void eventHappened(GadgetEvent e) {
                if (e.getID() == GadgetEvent.GADGET_COMPONENT_MAXIMIZED) {
                    ...
                    if (gadgetComponent instanceof CollapsiblePaneGadgetComponent) {
                        ((CollapsiblePaneGadgetComponent) gadgetComponent).setMaximized(true);
                    }
                }
                    ...
                    if (gadgetComponent instanceof CollapsiblePaneGadgetComponent) {
                        ((CollapsiblePaneGadgetComponent) gadgetComponent).setMaximized(false);
                    }
                }
            }
        });
