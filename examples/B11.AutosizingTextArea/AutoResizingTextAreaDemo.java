...
public class AutoResizingTextAreaDemo extends AbstractDemo {
    ...
    public String getDescription() {
        return "AutoResizingTextArea is a special text area which automatically resizes itself vertically. This is an ideal candidate when you want to show a smaller text area initially. When user starts to type in a lot of text, it automatically increases so that more text can be read.\n" +
