...
public class DateChooserDemo extends AbstractDemo {
    ...
    protected Component createOptionPanel() {
        ...
        panel.add(new JLabel("The selection Mode"));
        ...
        panel.add(Box.createVerticalStrut(12), JideBoxLayout.FIX);
        final JCheckBox todayCheckBox = (JCheckBox) panel.add(new JCheckBox("Show the \"Today\"/\"Now\" button"));
        ...
        final JCheckBox prevCheckBox = (JCheckBox) panel.add(new JCheckBox("Show the previous month button"));
        ...
        final JCheckBox prevYearCheckBox = (JCheckBox) panel.add(new JCheckBox("Show the previous year button"));
        ...
        final JCheckBox nextYearCheckBox = (JCheckBox) panel.add(new JCheckBox("Show the next year button"));
