...
//        });
    ...
    protected enum Priority { // in case of being obfuscated in the formal release, use protected here.
    ...
    private PropertyTable createTable() {
        ...
        final EnumConverter priorityConverter = new EnumConverter(Priority.class);
...
/*
                    Object lastPathComponent = ((TreePath) object).getLastPathComponent();
                    if (lastPathComponent instanceof DefaultMutableTreeNode) {
                        object = ((DefaultMutableTreeNode) lastPathComponent).getUserObject();
                    }
                    else {
...
*/
        ...
        property = new SampleProperty("CheckBoxTree", "This row shows you how to create a cell editor for check box tree", String[].class);
        property.setEditorContext(CheckBoxTreeComboBoxCellEditor.CONTEXT);
        list.add(property );
