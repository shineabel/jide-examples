...
public class ExComboBoxDemo extends AbstractDemo {
    ...
    private JComboBox[] _comboBoxes = new JComboBox[36];
    ...
    public Component getDemoPanel() {
        ...
        ExComboBox fontNameComboBox = createNavigationListComboBox(fontNames);
        fontNameComboBox.setEditable(true);
        fontNameComboBox.setSelectedItem("Arial");
        panel.add(createTitledComponent("ListExComboBox (Font Name, Expanded Tip)", "ExComboBox to choose font name or type in font name directly", fontNameComboBox));
...
//        new ListExComboBoxSearchable(multiSelectListComboBox2);
        ...
        ((TreeExComboBox) treeComboBox).setSearchUserObjectToSelect(true);
        ...
        TableExComboBox tableComboBox = new TableExComboBox(DemoData.createQuoteTableModel(false)) {
            @Override
        ...
        TableExComboBox tableComboBox2 = new TableExComboBox(DemoData.createQuoteTableModel(false)) {
            @Override
            protected JTable createTable(TableModel model) {
                return new SortableTable(model);
            }
        ...
        // create CheckBoxTreeEx combobox
        CheckBoxTreeExComboBox checkBoxTreeExComboBox = new CheckBoxTreeExComboBox();
        checkBoxTreeExComboBox.setEditable(true);
        checkBoxTreeExComboBox.setSearchUserObjectToSelect(true);
        checkBoxTreeExComboBox.setType(TreePath[].class);
        checkBoxTreeExComboBox.setConverterContext(new ConverterContext("TreePath"));
        panel.add(createTitledComponent("CheckBoxTreeExComboBox", "ExComboBox which has a CheckBoxTree as the selection list", checkBoxTreeExComboBox));

        _comboBoxes[i++] = checkBoxTreeExComboBox;

        // create CheckBoxTreeEx combobox
        CheckBoxTreeExComboBox checkBoxTreeExComboBox2 = new CheckBoxTreeExComboBox();
        checkBoxTreeExComboBox2.setEditable(false);
        panel.add(createTitledComponent("CheckBoxTreeExComboBox", "ExComboBox which has a CheckBoxTree as the selection list", checkBoxTreeExComboBox2));

        _comboBoxes[i] = checkBoxTreeExComboBox2;
    ...
    private static ExComboBox createNavigationListComboBox(String[] items) {
        return new ListExComboBox(items, String.class) {
            @Override
            protected JList createList(ComboBoxModel model) {
                NavigationList list = new NavigationList(model);
                list.setExpandedTip(true);
                return list;
            }
        };
    }
