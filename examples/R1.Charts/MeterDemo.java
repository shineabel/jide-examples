...
public class MeterDemo extends AbstractDemo {
    ...
    public String getDescription() {
        return "This shows three Dials, each displaying one dimension of the red-green-blue parts of a colour. " +
                "The values change once per second as a 'random walk'. Notice how the dials do not switch abruptly to the new value, " +
