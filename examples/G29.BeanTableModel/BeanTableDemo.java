...
public class BeanTableDemo extends AbstractDemo {
    private static final long serialVersionUID = 2358609684073969183L;
    ...
    public String getDescription() {
        return "This is a demo of BeanTableModel. \n" +
                ...
                "will show the actual JLabel a as Swing component in a UI. When you change any proprieties in the JLabels, it will be reflected in the UI immediately.\n" +
                "\n" +
                "Demoed classes:\n" +
    ...
    public Component getDemoPanel() {
        ...
        List<JLabel> objects = new ArrayList<JLabel>();
        for (int i = 0; i < 8; i++) {
        ...
        _beanTableModel = new BeanTableModel<JLabel>(objects, introspector);
        try {
