...
public class AbstractStyleTableDemo extends AbstractDemo {
    ...
    public Component getOptionsPanel() {
        ...
        buttons[1] = new JRadioButton(new AbstractAction("Alert Style (for all negative values)") {
        ...
        buttons[2] = new JRadioButton(new AbstractAction("Emphasize Style (for all negative values)") {
        ...
        buttons[3] = new JRadioButton(new AbstractAction("Hide the text, hover to see tooltips (for all negative values)") {
