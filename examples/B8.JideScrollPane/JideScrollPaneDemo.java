...
public class JideScrollPaneDemo extends AbstractDemo {
    private static final long serialVersionUID = 3819370864780485466L;
    ...
    public String getDescription() {
        return "JideScrollPane is an extended version of JScrollPane. It adds the support for row footer, " +
                "column footer, scroll bar corner etc. components to JScrollPane. In the demo, the red, gray and blue " +
