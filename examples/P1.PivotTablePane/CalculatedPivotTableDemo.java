...
//        }));
    ...
    public Component getDemoPanel() {
        final TableModel tableModel = DemoData.createProductReportsTableModel(false, 0);
...
//        pivotDataModel.setCacheEnabled(false);
...
//        });
        ...
        pivotDataModel.getField("ProductName").setAllowedAsDataField(false);
        ...
        pivotDataModel.getField("ProductSales").setStatisticsCalculationType(PivotConstants.STATISTICS_CALCULATION_RUNNING_LEAF);
        pivotDataModel.getField("ProductSales").setAllowedAsColumnField(false);
        pivotDataModel.getField("ProductSales").setAllowedAsRowField(false);
