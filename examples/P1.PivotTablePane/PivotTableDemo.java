...
public class PivotTableDemo extends AbstractDemo {
    ...
    public Component getOptionsPanel() {
        ...
        columnWidthRespectField.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _pivotTablePane.getPivotDataModel().getField("ProductSales").setPreferredWidth(100);
        ...
        JCheckBox showContextMenu = new JCheckBox("Show Context Menu");
        showContextMenu.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                ((HeaderTable) _pivotTablePane.getRowHeaderTable()).setShowContextMenu(e.getStateChange() == ItemEvent.SELECTED);
                ((HeaderTable) _pivotTablePane.getColumnHeaderTable()).setShowContextMenu(e.getStateChange() == ItemEvent.SELECTED);
                ((DataTable) _pivotTablePane.getDataTable()).setShowContextMenu(e.getStateChange() == ItemEvent.SELECTED);
            }
        });
        showContextMenu.setSelected(((HeaderTable) _pivotTablePane.getRowHeaderTable()).isShowContextMenu());

        JCheckBox showDataFieldsInRowAreaCheckBox = new JCheckBox("Show Data Fields in Row Area");
        showDataFieldsInRowAreaCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _pivotTablePane.getPivotDataModel().setAlwaysRowDataFields(e.getStateChange() == 1);
            }
        });

        JCheckBox layoutDataFieldsFirstCheckBox = new JCheckBox("Layout Data Fields First");
        layoutDataFieldsFirstCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _pivotTablePane.getPivotDataModel().setLayoutDataFieldsFirst(e.getStateChange() == 1);
            }
        });

        JCheckBox showFilterButtonOnMouseOverCheckBox = new JCheckBox("Show Filter Button On Mouse Over");
        showFilterButtonOnMouseOverCheckBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _pivotTablePane.setShowFilterButtonsOnMouseOver(e.getStateChange() == 1);
            }
        });

        JCheckBox dataFieldsDuplicationEnabled = new JCheckBox("Enable Data Fields Duplication");
        dataFieldsDuplicationEnabled.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                _pivotTablePane.setDataFieldsDuplicationEnabled(e.getStateChange() == 1);
            }
        });
        ...
        panel.add(showContextMenu);
        panel.add(showDataFieldsInRowAreaCheckBox);
        panel.add(layoutDataFieldsFirstCheckBox);
        panel.add(showFilterButtonOnMouseOverCheckBox);
        panel.add(dataFieldsDuplicationEnabled);
    ...
    private CalculatedTableModel setupProductDetailsCalculatedTableModel(TableModel tableModel) {
        ...
        calculatedTableModel.addColumn(new AbstractCalculatedColumn(tableModel, "Sales2", BigDecimal.class) {
            ...
            public Object getValueAt(int rowIndex) {
                ...
                return new BigDecimal("" + valueAt).multiply(new BigDecimal(2));
            }
...
//        });
        ...
        pivotDataModel.getField("Sales2").setDescription("Double the value in the sales column and the type is BigDecimal for testing purpose");
