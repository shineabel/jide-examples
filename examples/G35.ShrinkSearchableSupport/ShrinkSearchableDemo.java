...
import com.jidesoft.tree.TreeComboBoxShrinkSearchableSupport;
...
public class ShrinkSearchableDemo extends AbstractDemo {
    ...
    public Component getDemoPanel() {
        ...
        new TreeComboBoxShrinkSearchableSupport(new TreeExComboBoxSearchable(treeExComboBox));

        TreeExComboBox editableTreeExComboBox = new TreeExComboBox();
        editableTreeExComboBox.setEditable(true);
        new TreeComboBoxShrinkSearchableSupport(new TreeExComboBoxSearchable(editableTreeExComboBox));

        CheckBoxListExComboBox listExComboBox = new CheckBoxListExComboBox(names) {
            protected void setupList(JList list) {
                super.setupList(list);

                Searchable searchable = new ListSearchable(list);
                searchable.setPopupLocation(SwingConstants.BOTTOM);
                searchable.setFromStart(false);
                searchable.setCaseSensitive(false);
                searchable.setWildcardEnabled(true);
                new ListShrinkSearchableSupport(searchable);
            }
        };

        ListExComboBox editableListExComboBox = new ListExComboBox(names);
        editableListExComboBox.setEditable(true);
        new ListComboBoxShrinkSearchableSupport(new ListExComboBoxSearchable(editableListExComboBox));

        final TableModel tableModel = DemoData.createQuoteTableModel(false);
        ...
        editableTableExComboBox.setEditable(true);
        ...
        listPanel.add(createTitledPanel(new JLabel("Searchable GroupList"), 'G', new JScrollPane(groupList)), JideBoxLayout.FIX);
        ...
        listPanel.add(createTitledPanel(new JLabel("Searchable ListExComboBox (Editable, in JIDE Grids)"), 'E', editableListExComboBox), JideBoxLayout.FIX);
        listPanel.add(createTitledPanel(new JLabel("Searchable TreeExComboBox (in JIDE Grids)"), 'R', treeExComboBox), JideBoxLayout.FIX);
        listPanel.add(createTitledPanel(new JLabel("Searchable TreeExComboBox (Editable, in JIDE Grids)"), 'X', editableTreeExComboBox), JideBoxLayout.FIX);
        listPanel.add(createTitledPanel(new JLabel("Searchable TableExComboBox (in JIDE Grids)"), 'T', tableExComboBox), JideBoxLayout.FIX);
        listPanel.add(createTitledPanel(new JLabel("Searchable TableExComboBox (Editable, in JIDE Grids)"), 'B', editableTableExComboBox), JideBoxLayout.FIX);
